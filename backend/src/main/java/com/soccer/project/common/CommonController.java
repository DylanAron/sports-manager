...
import com.soccer.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public ResponseEntity<String> uploadImage(MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            String pathUrl = FileUploadUtils.upload(RuoYiConfig.getUploadPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
            if (StringUtils.isNotEmpty(pathUrl)) {
                return ResponseEntity.success(pathUrl);
            }
        }
