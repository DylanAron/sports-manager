 ...
 * @date 2025/4/9  21:11
 */
@RequestMapping("/h5/singleBag")
@RestController
public class H5SingleBagController {
    @Autowired
    ...
    public ResponseEntity<List<H5SingleBagListVo>> getListH5(@PathVariable @NotNull(message = "天数不能为空") Integer days) {
        List<H5SingleBagListVo> result = singleBagGroupService.getListH5(days);
