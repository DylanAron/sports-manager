<template>
	<!-- 添加专家页面 -->
	<el-dialog v-model="data.openEditExpertDialog" title="修改专家信息" width="500" align-center @close="emit('update',{type: 1,reload: true})">
...
<script setup>
	...
	import { uploadAvatar, update } from '@/api/business/expert'
	const BASE_API = import.meta.env.VITE_APP_BASE_API;
	const props = defineProps(['openEditExpertDialog', 'detail'])
	const emit = defineEmits(['update'])
	const data = reactive({
		openEditExpertDialog: props.openEditExpertDialog,
