  ...
  <div class="main">
    ...
    <div class="body">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="halfScore" label="半场比分" width="100" />
        <el-table-column prop="fullScore" label="全场比分" width="100" />
    ...
    <el-dialog v-model="dialogVisible" :title="dialogType === 'add' ? '添加' : '修改'" width="650px" :close-on-click-modal="false" class="dialog" top="5vh">
      <el-form label-width="100px" v-if="form">
        ...
        <el-form-item label="半场比分" required>
          <el-input v-model="form.halfScore" placeholder="如 1-0" />
        </el-form-item>
        <el-form-item label="全场比分" required>
          <el-input v-model="form.fullScore" placeholder="如 2-1" />
        </el-form-item>
...
import { selectByPage, uploadImage, add, edit, del } from '@/api/business/halffull';
...
function openAddDialog() {
  ...
  form.value = { leagueName: '', leagueLogo: '', homeName: '', homeLogo: '', awayName: '', awayLogo: '', halfScore: '', fullScore: '', recommendContent: '', result: '', isTodayData: 0, matchDate: '', isHit: -1 };
